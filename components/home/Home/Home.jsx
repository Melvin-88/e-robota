...
class Home extends Component {
  ...
  _toggleAuthModal(options){
    ...
    this.setState({showModal: !this.state.showModal, modalType: options.type || 'login'});
  }

  _changeModalType(modalType) {
  ...
  _renderModalContent(){
    ...
    switch(modalType){
      case 'signup':
        return <Signup onChangeModalType={this._changeModalType}/>;
      case 'reset':

...
export default class ProfileGraduationForm extends Component {
  ...
  constructor(props){
    ...
    this.yearEnrollment = 10; // не ранее 10 лет от дня рождения
                ...
                <div className="formrow">
                  <div className="halfrow">
                    <Select
                      ...
                      options={this._generateYearOptions(this.yearEnrollment)}
                  ...
                  <div className="halfrow">
                    <Select
                      ...
                      options={this._generateYearOptions(this.yearEnding)}

...
export default class ProfileCoursesForm extends Component {
  ...
  _handleSelection(field, val, i) {
    ...
    this.setState({educationCourses: selectedEducationCourses, indexBlockFocus: null});
  }
  ...
  _addCourse(e) {
    ...
    indexBlockFocus: this.state.educationCourses.length});
  }
            ...
            return (
              <div key={'courses-' + i} className={'formLayerRow  ' + (i % 2 == 1 ? 'evenrow' : '')}>
                <TextInput
                  ...
                  errors={errors[i] && errors[i].course}
                  inputRef={el => {

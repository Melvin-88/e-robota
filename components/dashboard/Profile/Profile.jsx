  ...
  render(){
    ...
    <div className="dashboardContentWrapper">
      <div className="dashboardContentWrapper__row">
        ...
        <div className={s.dashboardContentWrapper__dashboardContent + ' ' + s.dashboardContentWrapper__dashboardContent_twoColumns}>
          <DashboardContent title={this.state.formTitle} breadcrumbs={breadcrumbs}>
